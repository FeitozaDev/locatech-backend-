...
public class PessoaService {
    ...
    public PessoaService(PessoaRepository veiculoRepository) {
        this.pessoaRepository = veiculoRepository;
    }
    ...
    public void updatePessoa (Pessoa pessoa, Long id) {
        ...
        if (update == 0) {
            throw new RuntimeException("Nenhuma pessoa encontrado (A) com o ID: " + id);
        }
    }
