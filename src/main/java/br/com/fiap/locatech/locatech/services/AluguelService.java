...
public class AluguelService {
    ...
    public AluguelService(AluguelRepository veiculoRepository) {
        this.aluguelRepository = veiculoRepository;
    }
    ...
    public void updateAluguel (Aluguel aluguel, Long id) {
        ...
        if (update == 0) {
            throw new RuntimeException("Nenhuma aluguel encontrado (A) com o ID: " + id);
        }
    }
